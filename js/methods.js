...
$.changeYear = async function (year) {
  ...
  _.each(yearPlaylists, function (playlist) {
    ...
    let headerLi = $("<li>");
    headerLi.attr("title", playlist.code);
    let link = $("<a>");
...
$.spotfiyLogin = function () {
  if($.genre) {
    window.location.href = "https://accounts.spotify.com/authorize?client_id=3c0bcabb9b94479fa174125745f056ae&response_type=token&redirect_uri=https%3A%2F%2Fjesusfreakplaylists.com%2F%23year%3D" + $.year + "%26genre%3D" + $.genre.replace(/\s/g, '');
  }
  else {
    window.location.href = "https://accounts.spotify.com/authorize?client_id=3c0bcabb9b94479fa174125745f056ae&response_type=token&redirect_uri=https%3A%2F%2Fjesusfreakplaylists.com%2Ffeatured%2F%23year%3D" + $.year + "%26code%3D" + $.code;
  }
};
